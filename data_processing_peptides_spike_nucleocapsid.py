...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 17:19:45 2020
...
# of the SARS-CoV-2 spike protein and a compared virus for a given HLA
df_SARS_spike_229E = overlap_rank(df_SARS_spike_EL, df_229E_EL, 'SARS-Cov-2 spike', 'HCov-229E')
df_SARS_spike_HKU1 = overlap_rank(df_SARS_spike_EL, df_HKU1_EL, 'SARS-Cov-2 spike', 'HCov-HKU1')
df_SARS_spike_NL63 = overlap_rank(df_SARS_spike_EL, df_NL63_EL, 'SARS-Cov-2 spike', 'HCov-NL63')
df_SARS_spike_OC43 = overlap_rank(df_SARS_spike_EL, df_OC43_EL, 'SARS-Cov-2 spike', 'HCov-OC43')
...
# Export as csv file
sorted_df_SARS_spike_229E.to_csv('SARS_spike_229E_rank.csv')
sorted_df_SARS_spike_HKU1.to_csv('SARS_spike_HKU1_rank.csv')
sorted_df_SARS_spike_NL63.to_csv('SARS_spike_NL63_rank.csv')
sorted_df_SARS_spike_OC43.to_csv('SARS_spike_OC43_rank.csv')

# Nucleocapsid
# =============================================================================

# Calculate the actual overlap, proportional overlap and the number HLA-ligands 
# of the SARS-CoV-2 nucleocapsid protein and a compared virus for a given HLA
df_SARS_nucleocapsid_229E = overlap_rank(df_SARS_nucleocapsid_EL, df_229E_EL, 'SARS-Cov-2 nucleocapsid', 'HCov-229E')
df_SARS_nucleocapsid_HKU1 = overlap_rank(df_SARS_nucleocapsid_EL, df_HKU1_EL, 'SARS-Cov-2 nucleocapsid', 'HCov-HKU1')
df_SARS_nucleocapsid_NL63 = overlap_rank(df_SARS_nucleocapsid_EL, df_NL63_EL, 'SARS-Cov-2 nucleocapsid', 'HCov-NL63')
df_SARS_nucleocapsid_OC43 = overlap_rank(df_SARS_nucleocapsid_EL, df_OC43_EL, 'SARS-Cov-2 nucleocapsid', 'HCov-OC43')
...
# Export as csv file
sorted_df_SARS_nucleocapsid_229E.to_csv('SARS_nucleocapsid_229E_rank.csv')
sorted_df_SARS_nucleocapsid_HKU1.to_csv('SARS_nucleocapsid_HKU1_rank.csv')
sorted_df_SARS_nucleocapsid_NL63.to_csv('SARS_nucleocapsid_NL63_rank.csv')
sorted_df_SARS_nucleocapsid_OC43.to_csv('SARS_nucleocapsid_OC43_rank.csv')

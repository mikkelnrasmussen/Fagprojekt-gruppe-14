...
df_SARS_229E = overlap_rank(df_SARS_SB, df_229E_SB, 'SARS-Cov-2', 'HCov-229E')
df_SARS_HKU1 = overlap_rank(df_SARS_SB, df_HKU1_SB, 'SARS-Cov-2', 'HCov-HKU1')
df_SARS_NL63 = overlap_rank(df_SARS_SB, df_NL63_SB, 'SARS-Cov-2', 'HCov-NL63')
df_SARS_OC43 = overlap_rank(df_SARS_SB, df_OC43_SB, 'SARS-Cov-2', 'HCov-OC43')
...
# Export as csv file
sorted_df_SARS_EBOV.to_csv('SARS_EBOV_rank.csv')
sorted_df_SARS_H3N2.to_csv('SARS_H3N2_rank.csv')
sorted_df_SARS_229E.to_csv('SARS_229E_rank.csv')
sorted_df_SARS_HKU1.to_csv('SARS_HKU1_rank.csv')
sorted_df_SARS_NL63.to_csv('SARS_NL63_rank.csv')
sorted_df_SARS_OC43.to_csv('SARS_OC43_rank.csv')

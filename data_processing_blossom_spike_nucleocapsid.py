...
# Import csv files containing the BLOSUM-scores from the 6 comparisons with SARS-CoV-2 spike protein
...
# above a certain threshold BLOSUM-score (here 0.8) between the spike of SARS-CoV-2 and another virus.
...
# Sort HLA alleles based on porportional overlap
...
# Import csv files containing the BLOSUM-scores from the 6 comparisons with SARS-CoV-2 nucleocapsid protein
...
# Calculate the number and proportional overlap of similar HLA-ligands 
# above a certain threshold BLOSUM-score (here 0.8) between the nucleocapsid of SARS-CoV-2 and another virus.

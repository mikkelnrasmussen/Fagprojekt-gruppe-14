...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 16:22:32 2020
...
df_OC43_blosum = pd.read_csv('pep2score/blosum-SARS-Cov-2-HCov-OC43/blosum_SARS-Cov-2_HCov-OC43_combined.csv')
...
# Export as csv file
df_SARS_HKU1.to_csv('SARS_HKU1_blosum_overlap.csv')
df_SARS_229E.to_csv('SARS_229E_blosum_overlap.csv')
df_SARS_NL63.to_csv('SARS_NL63_blosum_overlap.csv')
df_SARS_OC43.to_csv('SARS_OC43_blosum_overlap.csv')
df_SARS_EBOV.to_csv('SARS_EBOV_blosum_overlap.csv')
df_SARS_H3N2.to_csv('SARS_H3N2_blosum_overlap.csv')

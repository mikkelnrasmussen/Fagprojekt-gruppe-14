...
# Function dividing the HLA-ligands, where anchor points are excluded,
# into lengths of 8-11 amino acids and outputting them in csv files
...
def subsetPeptideLengthExAnchors(virus, virus_name):
     ...
     for i in hla_list:
        ...
        # Remove second amino acids in all sequences
        ...
        # Remove last amino acids in all sequences
...
# Call subsetPeptideLength in order to divide HLA-ligands based on length and exclude anchor points
